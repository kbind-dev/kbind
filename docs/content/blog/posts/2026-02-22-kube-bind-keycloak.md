...
!!! note "Historical 0.x article"
    The Keycloak walkthrough is preserved from the 0.x documentation. Backend flags and callbacks have changed, use the [v2 OIDC configuration](../../developers/backend/oidc/index.md).
